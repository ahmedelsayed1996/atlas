...
import notificationsSlice from "./reduxTool-kit/slices/notificationsSlice";
...
import languageStudySlice from "./reduxTool-kit/slices/languageStudySlice";
export const store = configureStore({
  reducer: {
    ...
    languageStudy: languageStudySlice,
  },
});
