...
function AboutUs() {
  ...
  return (
    <>
        ...
        <div className="w-full px-5 lg:px-16 xl:px-28">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 py-6">
            <article className="md:order-1">
              {/* Mobile smaller, scale up to ~32px equivalent */}
              <p className="font-bold text-xl sm:text-2xl md:text-3xl leading-relaxed text-neutral-900">
            ...
            <article className="md:order-2 md:text-start">
              {/* Mobile smaller; matches ~18px at md and ~20px at lg */}
              <p className="font-normal text-sm sm:text-base md:text-lg lg:text-xl leading-relaxed text-zinc-700">
      ...
      {/*  counters */}
      <section className="bg-neutral-50 py-8">
        <div className="w-full  8 rounded-3xl   grid grid-cols-1 sm:grid-cols-3 text-center  ">
        ...
        <div className="px-5 lg:px-16 xl:px-28">
          <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-8 md:gap-10">
            ...
            <div className="order-1 md:order-2">
              <h2 className="font-bold text-lg sm:text-xl md:text-2xl leading-[1.4]  border-s-4 border-[#365D8D] ps-2">{x("card3")}
              </h2>
      ...
      <section className="py-12 bg-neutral-50"  >
        <div className="px-5 lg:px-16 xl:px-28">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5   overflow-hidden">
            ...
            <div className=" bg-white rounded-lg p-5">
              <div className="flex flex-col items-start gap-3">
                <Image src="/images/vision1.png" alt="logo" width={140} height={140} />
                <div className="font-bold text-lg sm:text-xl md:text-2xl leading-[1.4] leading-[160%]  ">
                  {x("card1")}
                </div>
                <p className="font-normal sm:text-lg text-sm    [color:#333333]">
